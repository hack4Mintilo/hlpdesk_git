...
<html>
  <head>
    <meta charset="utf-8">
    <title>How to setup a git environment in any path?</title>
  </head>
  <body>
...
<ul>
  ...
  <li>Once the git repository is clonned to your local machine, you're ready to develop your project</li>
</ul>

<h3>How to push new files to GitHub repo?</h3>
<ul>
  <li>cd proj_mintilo_python</li>
  <li>touch test321.py</li>
  <li>git status</li>
  <li>git add test321.py</li>
  <li>git commit -m "adding test321.py file"</li>
  <li>git push</li>
</ul>
